...
public class TextUi {
    ...
    public String getUserCommand() {
        out.print(Formatter.userCommand);
        ...
        showToUser(Formatter.repeatCommand(fullInputLine));
    ...
    public void showGoodbyeMessage() {
        showToUser(Formatter.goodbyeMessage);
    }
    ...
    public void showToUser(String... message) {
        for (String m : message) {
            out.println(Formatter.formatMessageToUser(m));
        }
    }
    ...
    public void showResultToUser(CommandResult result) {
        ...
        showToUser(Formatter.formatResultToUser(result.getFeedbackToUser()));
    }
    ...
    private void showPersonListView(List<? extends ReadOnlyPerson> persons) {
        showToUserAsIndexedList(Formatter.formatPerson(persons));
    }
